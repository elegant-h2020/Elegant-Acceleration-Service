...
public class LinuxTornadoVM implements TornadoVMInterface {
    ...
    private String[] getCommandForCompileToBytecode(long id, String functionName) {
        ...
        args.add("-cp");
        args.add(environmentTornadoVM.get(EnvironmentVariables.TORNADOVM_ROOT) + "/dist/tornado-sdk/tornado-sdk-0.16-dev-ec27019/share/java/tornado/tornado-api-0.16-dev.jar");
        args.add("-g:vars");
