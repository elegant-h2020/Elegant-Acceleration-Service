...
public class ElegantFileHandler {
    ...
    // private static CompilerRequest parseJsonFileToCompilerRequest(String
    // fileName) {
    ...
    // Map<Object, Object> fileInfoMap = (Map<Object, Object>)
    // (jsonObject.get("fileInfo"));
    ...
    // Map<Object, Object> deviceInfoMap = (Map<Object, Object>)
    ...
    // break;
    // case "maxWorkItems":
    // Map<Object, Object> maxWorkItemsMap = (Map<Object, Object>) ((JSONObject)
    // value);
    ...
    // }
    // });
    // DeviceInfo deviceInfo = new DeviceInfo(deviceName[0], doubleFPSupport[0],
    // maxWorkItems[0], deviceAddressBits[0], deviceType[0], deviceExtensions[0],
    ...
    // }
    //
    // private static void writeInputStreamToFile(InputStream inputStream, File
    ...
    // iterateAndParseUploadFilesFromRequest(HttpServletRequest request) {
    ...
    // } else if (itemName.contains(".java") || itemName.contains(".cpp") ||
    // itemName.contains(".c")) {
    ...
    // compilerRequest.setResponse(Response.status(code).entity(msg).build());
    // } else {
    // msg = "Files are not loaded correctly.";
    // compilerRequest.setResponse(Response.status(code).entity(msg).build());
    // }
    // } else {
    // compilerRequest = new CompilerRequest();
    // code = 404;
    // msg = "Internal error. The submitted request is not handled properly.";
    // compilerRequest.setResponse(Response.status(code).entity(msg).build());
    // }
    // TransactionMetaData transactionMetaData = new
    // TransactionMetaData(compilerRequest, fileName);
